...
ALTER TABLE "products_to_collections" ADD CONSTRAINT "products_to_collections_collection_id_collections_id_fk" FOREIGN KEY ("collection_id") REFERENCES "public"."collections"("id") ON DELETE cascade ON UPDATE no action;